...
class AdaptiveFSMOpen:
    """
    Speculare a AdaptiveFSM (chiusura):
    ...
    def update(
        ...
        *,
        ...
        g_thresh = self.grip_thresh(handle_friction)
        d_thresh = self.grasp_dist_thresh(handle_radius)
        ...
        # PHASE_RETREAT: transizioni/terminazione gestite dall'environment
        return events
